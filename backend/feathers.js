...
app.use(
  ...
  service({
    ...
    paginate: {
      // (optional) a pagination object containing a default and max page size
...
app.service("messages").find({
  query: {
    ...
    $sort: {
      // will sort based on the object you provide. It can contain a list of properties by which to sort mapped to the order
      createdAt: -1
    },
    $or: [
